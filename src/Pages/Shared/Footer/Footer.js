...
const Footer = () => {
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3 lg:pr-10" >
			<Link rel="noopener noreferrer" to="#" className="">
				...
				<h1 className="self-center text-2xl font-semibold pb-5">PLUMBOY</h1>
                <span>
                we love what we do, and we believe in it. Its not just plumbing to us, but a philosophy applied to every area of our lives. Its just the plumbing thats made us famous.
                </span>
			</Link>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/4 sm:grid-cols-4">
			<div className="space-y-3">
				...
				<ul className="space-y-3">
					...
					<li>
						<Link rel="noopener noreferrer" to="/review">My review</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" to="/service">service</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" to="/clog">Blog</Link>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© All rights reserved by shahed mridha</div>
</footer>
        </div>
    );
};
