      ...
      <div className="mx-auto container f-f-p px-4 xl:px-0 py-24">
        ...
        <div className="md:mt-24 f-f-p">
          <div className="hidden md:flex justify-center w-full">
            ...
            <div className="flex flex-col items-center md:items-start md:pl-12 lg:border-gray-400 mt-20 md:mt-0 md:w-1/2">
              ...
              <div className="flex mt-6 flex-col items-center md:items-start md:w-8/12">
                ...
                <h2 className="focus:outline-none text-gray-500 mt-3 text-base leading-6 tracking-wide">Sign up on our website and opt for which option that suits you the best . </h2>
              </div>
              ...
              <div className="flex mt-6 flex-col items-center md:items-start md:w-8/12">
                ...
                <h2 className="focus:outline-none text-gray-500 mt-3 text-base leading-6 tracking-wide">Create a wallet by linking a payment method that you are comfortable with. Paypal, Visa and more .</h2>
              </div>
            </div>
          </div>
          <div className="md:hidden flex flex-col items-center w-full">
            ...
            <div className="mt-10">
              <h1 className="text-xl tracking-wide text-center leading-5 font-bold">Choose Your needed Option</h1>
              <h2 className="text-gray-500 mt-3 pl-3 text-center text-base leading-6 tracking-wide">I am professional plamboy . My all service are here. If you need any service please create an account and choose your option</h2>
            </div>
            ...
            <div className="flex mt-10 flex-col items-center md:items-start md:w-8/12">
              <h1 className="text-xl text-center tracking-wide leading-5 font-bold">Create a Wallet</h1>
              <h2 className="text-gray-500 mt-3 text-center text-base leading-6 tracking-wide">Create a wallet by linking a payment method that you are comfortable with. Paypal, Visa and more .</h2>
            </div>
          </div>
        </div>
      </div>
